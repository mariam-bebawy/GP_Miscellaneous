...
void calculate_opticalflow(vector<Mat>* flow_fields, VideoCapture cap, int num_frames, Mat Mask);
...
vector<vector<Mat>> integrateflowfield(vector<Mat>* flowfields, Mat mask);
